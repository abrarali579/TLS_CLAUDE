...
| When | What happens |
|---|---|
| Every push to `main` | Check imports, build, run 149 tests, run the real-browser tests, verify the file is self-contained, publish it as a downloadable artifact |
